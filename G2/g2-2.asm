...
longest_path:
    ...
    long_loop:
        ...
        addiu $sp, $sp, -12             # make room for 4 elements on the stack
...
collatz:
        ...
        #BODY
        addiu $t5, $zero, 1             # Create a 1 for comparison
        addu  $v0, $zero, $zero         # Clear result register

        beq $a0, $t5, coll_done         # if (n==1) goto coll_done

        andi $t1, $a0, 1                # $t1 = 0 if n%2 == 0
        beq $t1, $zero, coll_elif       #if (n%2 != 0) goto coll_elif
    ...
    coll_endif:
        jal collatz                     # call recursively
        addiu $v0, $v0, 1               # result = collatz(n) + 1
